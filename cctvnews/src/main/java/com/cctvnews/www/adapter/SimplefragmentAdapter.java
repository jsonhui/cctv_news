 ...
 */
public class SimplefragmentAdapter extends AbsBaseAdapter<NewsRefreshDatas.ItemListBean> {
    ...
    public SimplefragmentAdapter(Context context, List<NewsRefreshDatas.ItemListBean> data) {
        super(context, data);
    }
    ...
    public int getItemViewType(int position) {
        String articleType = getData().get(position).getItemType();
        ...
        switch (articleType) {
            ...
            case "vod_flag":
                ...
                break;
            case "album_flag":
                if ("".equals(getData().get(position).getItemImage().getImgUrl3())) {
                    type = TYPE_3;
                } else if ("".equals(getData().get(position).getItemImage().getImgUrl2())){
                    type = TYPE_3;
                }else {
                    type = TYPE_2;
                }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        switch (type) {
            case TYPE_0:
                commom.common_tittle_tv.setText(getData().get(position).getItemTitle());
                Picasso.with(this.context).load(getData().get(position).getItemImage().getImgUrl1())
                        .into(commom.common_iv);
                if (getData().get(position).getPubDate().equals("0")) {
                ...
                break;
            case TYPE_1:
                video.tittle_tv.setText(getData().get(position).getItemTitle());
                Picasso.with(this.context).load(getData().get(position).getItemImage().getImgUrl1())
                        .into(video.video_iv);
                break;
            case TYPE_2:
                    moreImage.moreImage_tv.setText(getData().get(position).getItemTitle());
                    Picasso.with(this.context).load(getData().get(position).getItemImage().getImgUrl1())
                            .into(moreImage.moreImage_iv01);
                    Picasso.with(this.context).load(getData().get(position).getItemImage().getImgUrl2())
                            .into(moreImage.moreImage_iv02);
                    Picasso.with(this.context).load(getData().get(position).getItemImage().getImgUrl3())
                            .into(moreImage.moreImage_iv03);
                break;
            case TYPE_3:
                noneCommon.nonecommon_tittle_tv.setText(getData().get(position).getItemTitle());
                Picasso.with(this.context).load(getData().get(position).getItemImage().getImgUrl1())
