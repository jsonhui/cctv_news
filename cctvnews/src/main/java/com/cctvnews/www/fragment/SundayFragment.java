...
public class SundayFragment extends BaseFragment {
    ...
    public static SundayFragment newInstance(String path, MyJCVideoPlayerStandard jiecaoView) {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.activity_sunday, container, false);
        ...
        /**绑定适配器**/
        sundayList.setAdapter(programAdapter);
        /**数据**/
